      ...
      <div className="flex flex-col items-center mt-6">
        ...
        >
          ...
          <div className="flex justify-between py-2">
            ...
            <span className="font-medium text-white text-sm">35–45 minutes</span>
          </div>

          <div className="flex justify-between py-2">
            <span className="text-neutral-500 text-sm">Order Summary</span>
            <span className="font-medium text-white text-sm">
              Pizza, Wings, Soda <span className="text-neutral-400">(3 items)</span>
            </span>
          </div>
        </motion.div>
        ...
        <div className="w-full max-w-sm mt-7 space-y-3">
          ...
          <motion.button
            ...
            className="w-full py-3 bg-orange-400 text-black font-semibold text-base rounded-2xl transition"
          >
            Track Order
          </motion.button>
          ...
          <motion.button
            ...
            onClick={() => { navigate("/"); }}
            className="w-full py-3 bg-[#1A1A1A] border border-[#2B2B2B] text-white font-semibold text-base rounded-2xl transition"
          >
            Back to Home
          </motion.button>
